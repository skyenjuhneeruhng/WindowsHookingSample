...
// Dialog Data
	...
	protected:
	afx_msg LRESULT OnHookKeyboard(WPARAM wParam, LPARAM lParam);          
	afx_msg LRESULT OnHookLowKeyboard(WPARAM wParam, LPARAM lParam);
	afx_msg LRESULT OnHookMouse(WPARAM wParam, LPARAM lParam);
